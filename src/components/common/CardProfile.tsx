...
export const CardProfile = () => {
  ...
  return (
    <div className="bg-white dark:bg-dark p-5 shadow-nav rounded-xl text-gray-600 dark:text-light space-y-5 md:space-y-2 lg:space-y-5 md:h-card flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-5 md:gap-2 xl:gap-5">
        <a
          href="https://res.cloudinary.com/dmgazox1n/image/upload/v1732036456/Portfolio/PDF/HILDER-RODY-HUANCAS-CHUQUIPOMA.pdf"
          className="rounded-lg text-white py-3 px-3 border border-blue-500 bg-blue-500 flex items-center justify-center gap-2 hover:bg-blue-600 transition-colors duration-300"
        ...
        <button
          onClick={copy} 
          className="rounded-lg py-3 px-3 border border-gray-500 bg-transparent flex items-center justify-center gap-2 hover:bg-gray-700 hover:text-white dark:bg-light dark:text-dark dark:border-light transition-colors duration-300"
      ...
      <div className="flex md:hidden lg:flex items-center gap-5">
        <LinkSocial
